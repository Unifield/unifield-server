...
class sale_order_line(osv.osv):
    ...
    def create(self, cr, uid, vals, context=None):
        ...
        if 'product_id' in vals and vals['product_id']:
            ...
            # TO CHECK ? in which situation we get the supplier_id in the vals dic ?
            if 'supplier_id' in vals:
                sellerId = vals['supplier_id']
    ...
    def write(self, cr, uid, ids, vals, context=None):
        ...
        if 'fromSourcingLine' not in context:
            ...
            if 'product_id' in vals:
                ...
                # TO CHECK ? how can we reach this situation ?
                if 'supplier_id' in vals:
                    values.update({'supplier': vals['supplier_id']})
