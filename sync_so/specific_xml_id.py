...
# This method causes a lock in problem and needs to be justified, indeed we have a kind of error:
# this record has been modified while you were trying to delete it. => it may be caused by the "model_data.unlink(cr, uid, data_ids)" (l.150)
#
