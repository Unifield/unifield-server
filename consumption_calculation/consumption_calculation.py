...
class real_average_consumption(osv.osv):
    ...
    def cancel_button(self, cr, uid, ids, context=None):
        ...
        for report_id in ids:
            self.infolog(cr, uid, _('The consumption report id:%s has been canceled') % report_id)
    ...
    def process_moves(self, cr, uid, ids, context=None):
        ...
        for report_id in ids:
            self.infolog(cr, uid, _('The consumption report id:%s has been processed') % report_id)
...
class real_consumption_change_location(osv.osv_memory):
    ...
    def change_location(self, cr, uid, ids, context=None):
        ...
        self.infolog(cr, uid, _('Consumer location has been changed on consumption report id:%s from id:%s to id:%s') % (
