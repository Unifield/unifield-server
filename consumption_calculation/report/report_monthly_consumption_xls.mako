...
<Column ss:AutoFitWidth="1" ss:Width="300" />
    <Row>
        ...
        <Cell ss:StyleID="header" ><Data ss:Type="String">AMC</Data></Cell>
        <Cell ss:StyleID="header" ><Data ss:Type="String">FMC</Data></Cell>
        <Cell ss:StyleID="header" ><Data ss:Type="String">Valid Until</Data></Cell>
    </Row>
