...
<Table ss:ExpandedColumnCount="14" ss:ExpandedRowCount="${len(objects)+1}" x:FullColumns="1"
x:FullRows="1">
% for x in range(0,14):
<Column ss:AutoFitWidth="1" ss:Width="70" />
% endfor
<Row>
% for header in [_('Document Date'), _('Posting Date'), _('Entry Sequence'), _('Description'), _('Ref.'), _('Account'), _('Third Party'), _('Amount In'), _('Amount Out'), _('Book. Currency'), _('State'), _('Statement')]:
