...
class account_move_line(osv.osv):
    ...
    def calculate_output(self, cr, uid, currency_id, ml, context):
        ...
        return currency_obj.compute(cr, uid, original_currency, currency_id, func_amount, round=True, context=context)
    ...
    def _get_output(self, cr, uid, ids, field_name, arg, context=None):
        ...
        for ml in self.browse(cr, uid, ids, context=context):
            ...
            amount = self.calculate_output(cr, uid, currency_id, ml, context)
