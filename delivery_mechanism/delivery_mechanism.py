                    ...
                    if obj.purchase_line_id.procurement_id:
                        ...
                        if so_line_ids:
                            ...
                            for move in self.browse(cr, uid, move_ids, context=context):
                                ...
                                if (move.product_qty != 0.00 and move.picking_id.subtype == 'picking' and not move.picking_id.backorder_id and move.picking_id.state == 'draft') or (move.picking_id.subtype == 'standard') and move.picking_id.type == 'out':
