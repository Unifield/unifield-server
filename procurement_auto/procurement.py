...
class stock_warehouse_automatic_supply(osv.osv):
    ...
    _columns = {
        ...
        'frequence_id': fields.many2one('stock.frequence', string='Frequence', help='It\'s the time between two replenishments'),
        ...
        'next_date': fields.function(_get_next_date_from_frequence, method=True, string='Next scheduled date', type='date',
                                     help='While this date is not in the past, no new replenishment will be ran', 
