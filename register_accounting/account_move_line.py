...
class account_move_line(osv.osv):
    ...
    def _search_ready_for_import_in_register(self, cr, uid, obj, name, args, context=None):
        ...
        dom1 = [
            ...
            ('journal_id.type', 'in', ['purchase', 'sale','purchase_refund','sale_refund', 'hr', 'correction', 'intermission']),  # UTP-1088 add correction/intermission types
