                ...
                if order_field == 'id':
                    ...
                    if order_column._classic_read:
                        ...
                        if sort_raw_id:
                            ...
                            getter = lambda d, i: i.get(order_field) and isinstance(i.get(order_field), list) and len(d) > 1 and d[1].get(order_field) and i.get(order_field).index(d[1].get(order_field)) or False
                else:
                    raise NotImplementedError()
