...
class res_company(osv.osv):
    ...
    _columns = {
        ...
        'cash_credit_account_id': fields.many2one('account.account', 'Cash Default Credit Account',
                                                  domain=ACCOUNT_RESTRICTED_AREA['journals']),
        'other_debit_account_id': fields.many2one('account.account', 'Other Default Debit Account',
                                                 domain=ACCOUNT_RESTRICTED_AREA['journals']),
        'other_credit_account_id': fields.many2one('account.account', 'Other Default Credit Account',
                                                  domain=ACCOUNT_RESTRICTED_AREA['journals']),
