...
Our Ref, FO Date, Packing Date, RTS Date, Transport Mode. And the line 1 of the column 4, 7 and 12 \
must have these values: Shipper, Consignee, Destination Location.
