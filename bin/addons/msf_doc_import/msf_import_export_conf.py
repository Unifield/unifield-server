...
MODEL_DATA_DICT = {
    ...
    'suppliers': {
        'header_list': [
            ...
            ('address.country_id.name', 'address/country_id'),
            ('address.email', 'address/email'),
            ('property_account_payable.code', 'property_account_payable'),
            ('property_account_receivable.code', 'property_account_receivable'),
            'name',
            'lang',
            'partner_type',
            'customer',
            'supplier',
            ('property_product_pricelist_purchase.currency_id', 'property_product_pricelist_purchase'),
            ('property_product_pricelist.currency_id', 'property_product_pricelist'),
        ],
        'required_field_list': [
    ...
    # FINANCE
    # if the string to display in the header is different from the real tech
    # name of the field, use a tuple in header list instead of string:
    # (tech_name, name_to_diplay_in_the_header)
    'gl_accounts': {
        'header_list': [
            ...
            'activation_date',
            'code',
            ('default_destination_id.code', 'default_destination_id/id'),
            'inactivation_date',
            'type',
            'name',
            'note',
    ...
    'gl_journals': {
        'header_list': [
            ...
            ('default_credit_account_id.code', 'default_credit_account_id'),
            ('default_debit_account_id.code', 'default_debit_account_id'),
            'name',
            'type',
            ('analytic_journal_id.name', 'analytic_journal_id'),
        ],
        'required_field_list': [
            'code',
            'name',
