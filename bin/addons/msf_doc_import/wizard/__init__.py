...
RFQ_COLUMNS_HEADER_FOR_IMPORT = [
    ...
    (_('Delivery Request Date'), 'date'), (_('Currency'), 'string'), (_('Comment'), 'string'), (_('Justification Code'), 'string'), (_('Justification Coordination'), 'string'), (_('HQ Remarks'), 'string'), (_('Justification Y/N'), 'string'), (_('Status'), 'string')
]
...
FO_COLUMNS_HEADER_FOR_IMPORT=[
    ...
    (_('fo_import_price'), 'number'), (_('fo_import_drd'), 'date'), (_('fo_import_currency'), 'string'), (_('fo_import_comment'), 'string'), (_('Status'), 'string')]
