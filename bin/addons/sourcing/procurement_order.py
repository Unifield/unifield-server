...
""",
    ...
    def po_line_values_hook(self, cr, uid, ids, context=None, *args, **kwargs):
        ...
        if 'procurement' in kwargs:
            ...
            if procurement and procurement.tender_line_id and procurement.tender_line_idpurchase_order_line_id and procurement.tender_line_idpurchase_order_line_id.confirmed_delivery_date :
