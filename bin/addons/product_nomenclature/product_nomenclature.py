...
class product_product(osv.osv):
    ...
    def create(self, cr, uid, vals, context=None):
        ...
        if not (context.get('sync_update_creation') or context.get('sync_update_execution')) and self.pool.get('product.nomenclature').browse(cr, uid, vals['nomen_manda_3']).status == 'archived':
