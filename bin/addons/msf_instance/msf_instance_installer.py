...
class msf_instance_setup(osv.osv_memory):
    ...
    def _clean_after_instance_linked(self, cr, uid, context=None):
    ...
    def execute(self, cr, uid, ids, context=None):
        ...
        self._clean_after_instance_linked(cr, uid, context=context)
        return {}

    def action_check(self, cr, uid, ids, context=None):
        '''
            This method is not called during auto instance creation, but
            only during the manual instance creation
        '''
