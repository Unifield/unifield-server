...
class purchase_order_line(osv.osv):
    ...
    def button_validated(self, cr, uid, ids, context=None):
...
class purchase_order(osv.osv):
    ...
    def validate_lines(self, cr, uid, ids, context=None):
        ...
        return self.pool.get('purchase.order.line').button_validated(cr, uid, [pol.id for pol in po.order_line], context=context)
