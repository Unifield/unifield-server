...
class purchase_order(osv.osv):
    ...
    _columns = {
        ...
        'order_line': fields.one2many('purchase.order.line', 'order_id', 'Order Lines', readonly=True, states={'draft':[('readonly',False)], 'validated': [('readonly',False)], 'validated_p': [('readonly',False)]}),
