...
class inventory_report_template(report_sxw.rml_parse):

    def __init__(self, cr, uid, name, context):
        super(inventory_report_template, self).__init__(cr, uid, name, context=context)
        self.counter = 0
...
SpreadsheetReport('report.stock.inventory_report_xls', 'stock.inventory', 'addons/stock/report/inventory_report.xml', parser=inventory_report_template)
