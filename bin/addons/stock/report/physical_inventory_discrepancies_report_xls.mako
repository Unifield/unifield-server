 ...
 <Worksheet ss:Name="stock">
  ...
  <Table x:FullColumns="1"
   ...
   <Row ss:AutoFitHeight="0">
    ...
    <Cell ss:StyleID="s20"><NamedCell ss:Name="Print_Titles"/><NamedCell
      ss:Name="Print_Area"/></Cell>
    <Cell ss:StyleID="s20"><Data ss:Type="String">${_('Location')|x}</Data><NamedCell
      ss:Name="Print_Titles"/><NamedCell ss:Name="Print_Area"/></Cell>
    <Cell ss:StyleID="s21"><Data ss:Type="String">${ objects[0].location_id and objects[0].location_id.name or '' |x }</Data><NamedCell ss:Name="Print_Titles"/><NamedCell
      ss:Name="Print_Area"/></Cell>
   </Row>
   ...
   <Row ss:AutoFitHeight="0" ss:Height="46.5" ss:StyleID="s24">
    <Cell ss:StyleID="s26"><Data ss:Type="String">${_('Line #')|x}</Data><NamedCell
      ss:Name="Print_Titles"/><NamedCell ss:Name="Print_Area"/></Cell>
...
<% index = 0 %>
  ...
  <DataValidation xmlns="urn:schemas-microsoft-com:office:excel">
    <Range>R11C19:R${index+11}C19</Range>
    <Type>List</Type>
    <CellRangeList/>
