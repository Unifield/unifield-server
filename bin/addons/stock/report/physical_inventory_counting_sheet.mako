...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <DocumentProperties xmlns="urn:schemas-microsoft-com:office:office">
  ...
  <LastPrinted>2014-10-20T14:28:22Z</LastPrinted>
  <Created>2014-06-02T15:56:39Z</Created>
  <LastSaved>2017-09-27T08:25:31Z</LastSaved>
...
% for index,item in enumerate(objects[0].counting_line_ids):
   <Row ss:AutoFitHeight="0" ss:Height="15.75">
    ...
    <Cell ss:StyleID="s106"><Data ss:Type="String">${item.product_id and item.product_id.code or ''}</Data><NamedCell
      ss:Name="_FilterDatabase"/><NamedCell ss:Name="Print_Area"/></Cell>
    <Cell ss:StyleID="s106"><Data ss:Type="String">${item.product_id and item.product_id.name or ''}</Data><NamedCell
      ss:Name="_FilterDatabase"/><NamedCell ss:Name="Print_Area"/></Cell>
    <Cell ss:StyleID="s107"><Data ss:Type="String">${item.product_uom_id and item.product_uom_id.name or ''}</Data><NamedCell
      ss:Name="_FilterDatabase"/><NamedCell ss:Name="Print_Area"/></Cell>
    <Cell ss:StyleID="s108"><Data ss:Type="String">${item.quantity or ''}</Data><NamedCell
      ss:Name="_FilterDatabase"/><NamedCell ss:Name="Print_Area"/></Cell>
    <Cell ss:StyleID="s108"><Data ss:Type="String">${item.batch_number or ''}</Data></Cell>
    ...
    % endif
    <Cell ss:StyleID="s108"><Data ss:Type="String">${display_product_attributes(item)}</Data></Cell>
