...
% for o in objects:
<ss:Worksheet ss:Name="${sanitizeWSName("%s %s" % (o.composition_product_id.default_code and o.composition_product_id.default_code.replace('/', '_'), o.composition_reference and o.composition_reference.replace('/', '_')))|x}">
