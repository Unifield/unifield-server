...
<Column ss:Index="6" ss:AutoFitWidth="0" ss:Width="79.5"/>
<Column ss:AutoFitWidth="0" ss:Width="76.5"/>
<Column ss:AutoFitWidth="0" ss:Width="80.25" ss:Span="1"/>
<Column ss:Index="10" ss:AutoFitWidth="0" ss:Width="78.75"/>
...
<Cell ss:StyleID="s27">
<Data ss:Type="String">${_('Total Project - Actuals')}</Data>
</Cell>
<Cell ss:StyleID="s27">
<Data ss:Type="String">${_('Total Project - Balance')}</Data>
</Cell>
<Cell ss:StyleID="s28">
<Data ss:Type="String">${_('Total Project - %used')}</Data>
</Cell>
</Row>
...
<Cell ss:StyleID="s44">
<Data ss:Type="Number">${( getTot(0) or '')|x}</Data>
</Cell>
<Cell ss:StyleID="s44">
<Data ss:Type="Number">${( getTot(1) or '')|x}</Data>
</Cell>
