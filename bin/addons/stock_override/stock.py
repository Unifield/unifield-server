...
class stock_picking(osv.osv):
    ...
    def draft_force_assign(self, cr, uid, ids, context=None):
        ...
        ftf = ['partner_id', 'ext_cu', 'from_wkf']
...
class stock_move(osv.osv):
    ...
    _columns = {
        ...
        'from_wkf_line': fields.related('picking_id', 'from_wkf', type='boolean', string='Internal use: from wkf', write_relate=False),
        'is_ext_cu': fields.related('picking_id', 'ext_cu', type='boolean', string='Ext. CU', write_relate=False),
        'fake_state': fields.related('state', type='char', store=False, string="Internal use", write_relate=False),
        ...
        'from_wkf': fields.related('picking_id', 'from_wkf', type='boolean', string='From wkf', write_relate=False),
...
class stock_picking_cancel_wizard(osv.osv_memory):
    ...
    def _get_doc_type(self, cr, uid, context=None):
        """
        Is the document an OUT, a Pick or something else ?
        """
        if context is None:
            context = {}

        picking_id = context.get('active_id')
        pick = self.pool.get('stock.picking').read(cr, uid, picking_id, ['type', 'subtype'], context=context)
    ...
    _columns = {
        ...
        'doc_type': fields.selection(string="Document Type", selection=[('out', 'OUT'), ('pick', 'Picking'), ('other', 'Other')]),
    }
