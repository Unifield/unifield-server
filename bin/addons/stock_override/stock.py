...
class stock_picking(osv.osv):
    ...
    def create(self, cr, uid, vals, context=None):
        ...
        if vals.get('from_wkf') and vals.get('purchase_id'):
            po = self.pool.get('purchase.order').browse(cr, uid, vals.get('purchase_id'), fields_to_fetch=['dest_partner_names', 'short_customer_ref', 'linked_sol_id'], context=context)
