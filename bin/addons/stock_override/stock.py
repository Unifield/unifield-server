...
class stock_picking(osv.osv):
    ...
    _columns = {
        ...
        'dpo_id_incoming': fields.integer_big(string='Id of remote DPO', internal=1, select=1),
...
class stock_move(osv.osv):
    ...
    _columns = {
        ...
        'dpo_line_id': fields.integer_big(string='Direct PO line', help='PO line from where this stock move is sourced (for sync. engine).'),
