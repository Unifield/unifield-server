...
class patch_scripts(osv.osv):
    ...
    # UF37.0
    def us_11801_show_prod_status_inconsistencies(self, cr, uid, *a, **b):
        ...
        self.pool.get('ir.ui.menu').write(cr, uid, report_prod_inconsistencies_menu_id, {'active': True}, context={})
        return True
