...
class mission_stock_report_parser(XlsxReportParser):
...
XlsxReport('report.report_mission_stock_report', parser=mission_stock_report_parser, template='addons/mission_stock/report/mission_stock_report.xlsx')

XlsxReport('report.report_consolidated_mission_stock_report', parser=mission_stock_report_parser, template='addons/mission_stock/report/consolidated_mission_stock_report.xlsx')
