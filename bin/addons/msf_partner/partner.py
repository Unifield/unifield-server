    ...
    def fields_view_get(self, cr, uid, view_id=None, view_type='form', context=None, toolbar=False, submenu=False):
        ...
        if view_type == 'search':
            if not context or not context.get('show_button_show_inactive', False):
                ...
                fields = tree.xpath('//filter[@name="inactive"]|//filter[@name="phase_out"]|//filter[@name="active"]')
                for field in fields:
...
class res_partner_address(osv.osv):
    ...
    _columns = {
        ...
        'partner_type': fields.related('partner_id', 'partner_type', type='selection', selection=PARTNER_TYPE, string='Partner Type', write_relate=False),
    }
