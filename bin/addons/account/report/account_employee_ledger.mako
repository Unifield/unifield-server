...
<Worksheet ss:Name="${( get_employees() )|x}">
...
<Cell ss:StyleID="ssHeader">
    <Data ss:Type="String">${_('Employee')}</Data>
</Cell>
<Cell ss:StyleID="ssHeader">
...
% for p in employees_to_display(objects):
<!-- EMPLOYEE HEADER -->
<Row>
<Cell ss:StyleID="ssEmployee">
    <Data ss:Type="String">${p.name_resource or ''|x}</Data>
</Cell>
<Cell ss:StyleID="ssEmployee" ss:MergeAcross="5">
    <Data ss:Type="String"></Data>
</Cell>
<Cell ss:StyleID="ssEmployee">
    <Data ss:Type="String">${company.currency_id.name|x}</Data>
</Cell>
<Cell ss:StyleID="ssEmployeeNumber">
    <Data ss:Type="Number">${sum_debit_employee(p) or 0.|x}</Data>
</Cell>
<Cell ss:StyleID="ssEmployeeNumber">
    <Data ss:Type="Number">${sum_credit_employee(p) or 0.|x}</Data>
</Cell>
<Cell ss:StyleID="ssEmployeeNumber">
    <Data ss:Type="Number">${(sum_debit_employee(p) or 0.) - (sum_credit_employee(p) or 0.)|x}</Data>
</Cell>
<Cell ss:StyleID="ssEmployeeNumber">
    <Data ss:Type="Number">${(sum_debit_employee(p) or 0.) - (sum_credit_employee(p) or 0.)|x}</Data>
</Cell>
...
<WorksheetOptions xmlns="urn:schemas-microsoft-com:office:excel">
   ...
   <PageSetup>
    ...
    <Header x:Data="&amp;C&amp;&quot;Arial,Bold&quot;&amp;14Employee Ledger"/>
