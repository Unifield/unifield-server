...
class account_liquidity_balance(report_sxw.rml_parse, common_report_header):
    ...
    def _get_register_data(self):
        ...
        reg_types = ('cash', 'bank')
        params = (period_title, date_from, date_to, reg_types, date_from, reg_types, date_from, date_to, reg_types, date_to, date_from, date_to, tuple(self.instance_ids))
        ...
        cheque_params = (period_title, date_from, date_to, tuple(pending_chq_starting_bal_ids), tuple(pending_chq_closing_bal_ids), tuple(self.instance_ids))
