...
class free_allocation_wizard(osv.osv_memory):
    ...
    _columns = {
        ...
        'document_date_from': fields.date('Document date'),
        'document_date_to': fields.date('to'),
        'posting_date_from': fields.date('Posting date'),
        'posting_date_to': fields.date('to'),
    ...
    def print_free_allocation_report(self, cr, uid, ids, context=None):
        ...
        data = {
            ...
            'document_date_from': wiz.document_date_from or False,
            'document_date_to': wiz.document_date_to or False,
            'posting_date_from': wiz.posting_date_from or False,
            'posting_date_to': wiz.posting_date_to or False,
