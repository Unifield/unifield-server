...
<ss:Worksheet ss:Name="Pre-Packing Excel Report">
    <Table x:FullColumns="1" x:FullRows="1">
        ...
        <Row>
            ...
            <Cell ss:StyleID="line_borders_top" ss:MergeAcross="2"><Data ss:Type="String">${getPickingShipper()[0].get('shipper_name', '')|x}</Data></Cell>
        ...
        <Row>
            ...
            <Cell ss:StyleID="line_borders_middle" ss:MergeAcross="2"><Data ss:Type="String">${getPickingShipper()[0].get('shipper_contact', '')|x}</Data></Cell>
        ...
        <Row>
            ...
            <Cell ss:StyleID="line_borders_middle" ss:MergeAcross="2"><Data ss:Type="String">${getPickingShipper()[0].get('shipper_addr_street', '')|x}</Data></Cell>
        ...
        <Row>
            ...
            % endif
            <Cell ss:StyleID="line_borders_middle" ss:MergeAcross="2"><Data ss:Type="String">${getPickingShipper()[0].get('shipper_addr_zip_city', '')|x}</Data></Cell>
        ...
        <Row>
            ...
            <Cell ss:StyleID="short_date_center"><Data ss:Type="String"></Data></Cell>
            % endif
            <Cell ss:StyleID="line_borders_middle" ss:MergeAcross="2"><Data ss:Type="String">${getPickingShipper()[0].get('shipper_phone', '')|x}</Data></Cell>
