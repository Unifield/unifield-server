    ...
    def do_return_packs(self, cr, uid, ids, context=None):
        ...
        for wizard in self.browse(cr, uid, ids, context=context):
            ...
            for family in wizard.family_ids:
                ...
                if family.selected_number and family.parcel_ids_error:
        ...
        if negative_line_ids or too_much_line_ids or parcels_error_ids:
            return {
                'type': 'ir.actions.act_window',
                'res_model': self._name,
                'view_type': 'form',
...
class return_shipment_family_processor(osv.osv):
    ...
    def _get_pack_info(self, cr, uid, ids, field_name, args, context=None):
        ...
        for line in self.browse(cr, uid, ids, context=context):
            ...
            if line['selected_number'] and line['parcel_ids']:
