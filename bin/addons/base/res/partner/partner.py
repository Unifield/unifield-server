...
class res_partner(osv.osv):
    ...
    _columns = {
        ...
        'legal_name': fields.char('Legal Name', size=128, required=False),
        ...
        'phone': fields.related('address', 'phone', type='char', string='Phone', write_relate=True),
        'mobile': fields.related('address', 'mobile', type='char', string='Mobile', write_relate=True),
        'country': fields.related('address', 'country_id', type='many2one', relation='res.country', string='Country', write_relate=True),
...
class res_partner_address(osv.osv):
    ...
    _columns = {
        ...
        'is_customer_add': fields.related('partner_id', 'customer', type='boolean', string='Customer', write_relate=False),
        'is_supplier_add': fields.related('partner_id', 'supplier', type='boolean', string='Supplier', write_relate=False),
