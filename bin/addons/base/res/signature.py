...
list_sign = {
    ...
    'account.bank.statement.other_reg': [
        ('fr', _('Signature 1 - reconciliation'), True, 1),
        ('mr', _('Signature 2 - reconciliation'), True, 1),
        ('fr_report', _('Signature 1 - full report'), True, 1),
        ('mr_report', _('Signature 2 - full report'), True, 1),
...
saved_value = {
    ...
    'account.bank.statement': lambda doc: doc.journal_id.type in ('bank', 'cheque', 'other_reg') and round(doc.balance_end, 2) or doc.journal_id.type == 'cash' and round(doc.msf_calculated_balance, 2) or 0,
