...
class Entity(osv.osv):
    ...
    def clean_updates(self, cr, uid):
        ...
        self._logger.info('clean_updates method has deleted %s sync_client_update_received' % deleted_update_received)
        ...
        self._logger.info('clean_updates method has deleted %s sync_client_update_to_send' % deleted_update_to_send)
