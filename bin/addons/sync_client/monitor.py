...
class sync_monitor(osv.osv):
    ...
    _columns = {
        ...
        'user_rights': fields.selection(list(status_dict.items()), string="User Rights", readonly=True),
        'data_pull' : fields.selection(list(status_dict.items()), string="Data Pull", readonly=True),
        'data_pull_enddate': fields.datetime('End of Data Pull'),
        'data_pull_receive' : fields.selection(list(status_dict.items()), string="D. Pull receive", readonly=True),
        'data_pull_receive_enddate': fields.datetime('End of Data Pull Receive'),
        'data_pull_execute' : fields.selection(list(status_dict.items()), string="D. Pull execute", readonly=True),
        'data_pull_execute_enddate': fields.datetime('End of Data Pull Exec'),

        'msg_pull' : fields.selection(list(status_dict.items()), string="Msg Pull", readonly=True),
        'msg_pull_enddate': fields.datetime('End of Msg Pull'),
        'msg_pull_receive' : fields.selection(list(status_dict.items()), string="Msg Pull receive", readonly=True),
        'msg_pull_receive_enddate': fields.datetime('End of Msg Pull Receive'),
        'msg_pull_execute' : fields.selection(list(status_dict.items()), string="Msg execute", readonly=True),
        'msg_pull_execute_enddate': fields.datetime('End of Msg Pull Exec'),

        'data_push' : fields.selection(list(status_dict.items()), string="Data Push", readonly=True),
        'data_push_enddate': fields.datetime('End of Data Push'),
        'data_push_create' : fields.selection(list(status_dict.items()), string="Data Push create", readonly=True),
        'data_push_create_enddate': fields.datetime('End of Data Push Create'),
        'data_push_send' : fields.selection(list(status_dict.items()), string="Data Push send", readonly=True),
        'data_push_send_enddate': fields.datetime('End of Data Push Send'),

        'msg_push' : fields.selection(list(status_dict.items()), string="Msg Push", readonly=True),
        'msg_push_enddate': fields.datetime('End of Msg Push'),
        'msg_push_create' : fields.selection(list(status_dict.items()), string="Msg Push Create", readonly=True),
        'msg_push_create_enddate': fields.datetime('End of Msg Push Create'),
        'msg_push_send' : fields.selection(list(status_dict.items()), string="Msg Push Send", readonly=True),
        'msg_push_send_enddate': fields.datetime('End of Msg Push Send'),

        'status' : fields.selection(list(status_dict.items()), string="Status", readonly=True),
