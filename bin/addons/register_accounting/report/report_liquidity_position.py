...
class report_liquidity_position3(report_sxw.rml_parse):
    ...
    def getRegistersByType(self):
        ...
        journal_ids = journal_obj.search(self.cr, self.uid, [('type', 'in', ['bank', 'cash', 'other_reg'])], order='NO_ORDER')
        ...
        for reg in regs:
            ...
            if reg.journal_id.type == 'bank' or reg.journal_id.type == 'other_reg':
