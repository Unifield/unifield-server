    ...
    <Table>
      ...
      <Row ss:Height="19.3039">
        <Cell ss:MergeAcross="3" ss:StyleID="title">
          <Data ss:Type="String">${o.journal_id.type == 'cash' and _('CASH REGISTER FULL REPORT') or o.journal_id.type == 'bank' and _('BANK REGISTER FULL REPORT') or o.journal_id.type == 'cheque' and _('CHEQUE REGISTER FULL REPORT') or o.journal_id.type == 'other_reg' and _('MOBILE REGISTER FULL REPORT') or ''|x}</Data>
        </Cell>
      </Row>
      ...
      if o.journal_id.type == 'cash':
          ...
          elif o.journal_id.type == 'other_reg':
