...
class threshold_value_rules_report(osv.osv):
    ...
    _columns = {
        ...
        'manual_qty': fields.float(digits=(16,2), string='Manual Qty', readonly=True, related_uom='product_uom_id'),
        'safety_stock': fields.float(digits=(16,2), string='Safety stock', readonly=True, related_uom='product_uom_id'),
