...
class Entity(osv.osv):
    ...
    def usb_push(self, cr, uid, push_file_name, context):
        ...
        # cleanup
        self.usb_push_validate(cr, uid, session, context=context)
    ...
    def usb_push_validate(self, cr, uid, session_id, context=None):
        """
        ...
        update_pool = self.pool.get('sync_remote_warehouse.update_to_send')
        update_pool.sync_finished(cr, uid, session_id, sync_field='usb_sync_date', context=context)
