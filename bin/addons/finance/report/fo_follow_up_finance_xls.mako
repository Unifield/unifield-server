...
% for o in objects:
    <Table x:FullColumns="1" x:FullRows="1">
        ...
        <Row>
            ...
            <Cell ss:StyleID="ssCellBlue"><Data ss:Type="String">${get_company(o).instance_id.instance or '-'|x}</Data></Cell>
            <Cell ss:StyleID="ssCell"><Data ss:Type="String"></Data></Cell>
            <Cell ss:StyleID="ssCell" ss:MergeAcross="1"><Data ss:Type="String">${_('Partner:')|x}</Data></Cell>
            <Cell ss:StyleID="ssCellBlue" ss:MergeAcross="2"><Data ss:Type="String">${'-'|x}</Data></Cell>
        </Row>
        <Row>
