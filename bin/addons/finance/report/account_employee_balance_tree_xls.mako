...
<%
debit, credit, balance = get_employees_total_debit_credit_balance(data)
%>
<Cell ss:StyleID="ssCellRightBold" ss:MergeAcross="3">
    <Data ss:Type="String">${_('TOTAL EMPLOYEES')}</Data>
</Cell>
<Cell ss:StyleID="ssEmployeeRight">
    <Data ss:Type="String">${company.currency_id.name|x}</Data>
</Cell>
...
<%
employee_name = (p_obj.name or '')
%>
<Row>
<Cell ss:StyleID="ssEmployee" ss:MergeAcross="3">
    <Data ss:Type="String">${employee_name|x}</Data>
</Cell>
<Cell ss:StyleID="ssEmployeeRight">
    <Data ss:Type="String">${company.currency_id.name|x}</Data>
</Cell>
...
<WorksheetOptions xmlns="urn:schemas-microsoft-com:office:excel">
   ...
   <PageSetup>
    ...
    <Header x:Data="&amp;C&amp;&quot;Arial,Bold&quot;&amp;14Employee Balance"/>
