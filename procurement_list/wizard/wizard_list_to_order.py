...
class wizard_list_to_order(wizard.interface):

    def _get_order(self, cr, uid, data, context={}):
        '''
        Returns the Purchase Orders generated by the current
        Procurement List
        '''
        pool_obj = pooler.get_pool(cr.dbname)
        list_obj = pool_obj.get('procurement.list')
...
wizard_list_to_order('wizard_list_to_order')
