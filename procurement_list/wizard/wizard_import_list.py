...
class wizard_import_list(osv.osv_memory):
    _name = 'procurement.list.import'
    _description = 'Import of Procurement List'
    ...
    def import_file(self, cr, uid, ids, context={}):
        ...
        Procurement List
        '''
        list_line_obj = self.pool.get('procurement.list.line')
        list_obj = self.pool.get('procurement.list')
