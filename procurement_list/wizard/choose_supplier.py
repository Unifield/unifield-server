...
class procurement_list_line_split(osv.osv_memory):
    ...
    def default_get(self, cr, uid, fields, context={}):
        ...
        if state == 'done':
            raise osv.except_osv(_('Error'), _('You cannot split a line in a Done Procurement Request'))
...
class procurement_list_line_merge(osv.osv_memory):
    ...
    def default_get(self, cr, uid, fields, context={}):
        ...
        line = line_obj.browse(cr, uid, line_id, context=context)
        if state == 'done':
            raise osv.except_osv(_('Error'), _('You cannot merge a line in a Done Procurement Request'))
