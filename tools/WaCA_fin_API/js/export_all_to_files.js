...
/**
 * Retrieve available exports.
 */
async function getReadyToExport() {
...
async function main() {
    ...
    const records = await getReadyToExport();
    ...
    for (const row of records) {
        ...
        await exportToFile(
            ...
            [period, instance],
            1,
            `${period}_${instance}_accounting_entries.csv`
        );
        ...
        await exportToFile(
            ...
            [period, instance],
            1,
            `${period}_${instance}_matching_report.csv`
        );
        ...
        await exportToFile(
            ...
            [period, instance],
            1,
            `${period}_${instance}_balances.csv`
        );
    }
}
