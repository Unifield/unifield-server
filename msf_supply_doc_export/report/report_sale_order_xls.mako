...
## we loop over the sale_order_line
    ...
    <Row>
        <Cell ss:StyleID="so_header_data" ><Data ss:Type="String">${(line.default_code or '')|x}</Data></Cell>
        <Cell ss:StyleID="so_header_data" ><Data ss:Type="String">${(line.product_id.name or '')|x}</Data></Cell>
        <Cell ss:StyleID="so_header_data" ><Data ss:Type="Number">${(line.product_uom_qty)|x}</Data></Cell>
