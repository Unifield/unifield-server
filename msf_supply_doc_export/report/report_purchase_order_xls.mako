...
## we loop over the purchase_order_line
    ...
    <Row>
        ...
        <Cell ss:StyleID="date" ><Data ss:Type="DateTime">${line.date_planned|n}T00:00:00.000</Data></Cell>
        % elif o.delivery_requested_date:
        ## if the date does not exist in the line we take the one from the header
        <Cell ss:StyleID="date" ><Data ss:Type="DateTime">${o.delivery_requested_date|n}T00:00:00.000</Data></Cell>
        % endif
