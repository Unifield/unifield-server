...
class Translator(SecuredController):
    ...
    def save(self, translate='fields', **kw):
        ...
        return dict(close_popup=True, fields_values=base64.b64encode(bytes(json.dumps(fields_values), 'utf8')), concurrency_info=base64.b64encode(bytes(json.dumps(concurrency_info), 'utf8')))
