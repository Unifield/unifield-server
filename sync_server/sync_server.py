...
class sync_manager(osv.osv):
    ...
    @check_validated
    def get_update(self, cr, uid, entity, last_seq, offset, max_size, max_seq, all=False, context=None):
        """
            @param entity: string : uuid of the synchronizing entity
        ...
        """
        package = self.pool.get("sync.server.update").get_package(cr, uid, entity, last_seq, offset, max_size, max_seq, all=all, context=context)
