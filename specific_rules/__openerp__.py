...

{
    ...
    "depends" : ["sale", "sale_override", # sale override for Digit Precision data
                 "purchase", "stock", "procurement_cycle", "specific_locations", "reason_types_moves", "stock_override"],
    "init_xml" : [],
    "demo_xml" : [],
    "description": """
