...
class product_attributes(osv.osv):
    ...
    _columns = {
        ...
        'cold_chain': fields.selection([('',''),
            ('*','* Keep Cool: used for a kit containing cold chain module or item'),
            ...
            ('*D','*D Store and transport at -25°C (store in deepfreezer, transport with dry-ice)'),
            ('*F','*F CANNOT be frozen; check FreezeWatch'),
            ('*25','*25 Must be kept below 25°C (but not necesseraly in cold chain)'),
            ('*25F','*25F Must be kept below 25°C and cannot be frozen: check FreezeWatch'),
            ], 'Cold Chain'),
