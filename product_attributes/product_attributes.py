...
class product_attributes(osv.osv):
    ...
    _columns = {
        ...
        'international_status': fields.selection([('',''),('itc','Approved (ITC)'),('esc', 'Approved (ESC)'),('hq', 'HQ'),('local','Not approved (Local)'),('temp','Temporary')], 
                                                 string='International Status', required=True),
