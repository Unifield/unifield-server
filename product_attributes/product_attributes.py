...
class product_attributes(osv.osv):
    ...
    _columns = {
        ...
        'cold_chain': fields.selection([('',''),
            ('3*','3* Cold Chain * - Keep Cool: used for a kit containing cold chain module or item'),
            ('6*0','6*0 Cold Chain *0 - Problem if any window blue'),
            ('7*0F','7*0F Cold Chain *0F - Problem if any window blue or F'),
            ('8*A','8*A Cold Chain *A - Problem if A and D totally blue'),
            ('9*AF','9*AF Cold Chain *AF - Problem if A and D tot. blue or F'),
            ('10*B','*10*B Cold Chain *B - Problem if B and D totally blue'),
            ('11*BF','11*BF Cold Chain *BF - Problem if B and D tot. blue or F'),
            ('12*C','12*C Cold Chain *C - Problem if C and D totally blue'),
            ('13*CF','13*CF Cold Chain *CF - Problem if C and D tot. blue or F'),
            ('14*D','14*D Cold Chain *D - Store and transport at -25°C (store in deepfreezer, transport with dry-ice)'),
            ('15*F','*15*F Cold Chain *F - Cannot be frozen: chk FreezeWatch.'),
            ('16*25','16*25 Cold Chain *25 - Must be kept below 25°C (but not necesseraly in cold chain)'),
            ('17*25F','17*25F Cold Chain *25F - Must be kept below 25°C and cannot be frozen: check FreezeWatch'),
            ], 'Cold Chain'),
