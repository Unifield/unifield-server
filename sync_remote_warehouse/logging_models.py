...
class UpdateReceived(osv.osv):
    ...
    _columns = {
        ...
        # determines if this log was generated by a horizontal synchronisation, i.e. between a CP and RW
        'is_horizontal_synchronisation': fields.boolean('CP <--> RW Sync', help='Was this synchronisation horizontal, i.e. between a remote warehouse and a central platform?', readonly=True),
    } 
