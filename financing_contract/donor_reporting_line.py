...
class financing_contract_donor_reporting_line(osv.osv):
    ...
    _columns = {
        ...
        'allocated_budget': fields.function(_get_allocated_amounts, method=True, store=False, string="Budget allocated amount", type="float", readonly="True", multi="allocated"),
        'project_budget': fields.function(_get_project_amounts, method=True, store=False, string="Budget project amount", type="float", readonly="True", multi="project"),
        'allocated_real': fields.function(_get_allocated_amounts, method=True, store=False, string="Real allocated amount", type="float", readonly="True", multi="allocated"),
        'project_real': fields.function(_get_project_amounts, method=True, store=False, string="Real project amount", type="float", readonly="True", multi="project"),
