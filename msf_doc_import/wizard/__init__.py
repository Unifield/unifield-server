...
('Line*', 'number'), ('Product Code*', 'string'), ('Product Description', 'string'), ('Quantity*', 'number'), ('UoM*', 'string'), ('Price*', 'number'), ('Delivery Request Date', 'datetime'),
('Delivery Confirmed Date*', 'datetime'), ('Order Reference*', 'string'), ('Delivery Confirmed Date (PO)*', 'string'),
...
NEW_COLUMNS_HEADER = [
('Line*', 'number'), ('Product Code*', 'string'), ('Product Description', 'string'), ('Quantity*', 'number'), ('UoM*', 'string'), ('Price*', 'number'), ('Delivery Request Date', 'datetime'),
('Delivery Confirmed Date*', 'datetime'),('Origin', 'string'), ('Comment', 'string'), ('Notes', 'string'), ('Supplier Reference', 'string'), ('Incoterm', 'string')]
...
(_('Delivery requested date'), 'datetime'), (_('Currency'), 'string'), (_('Comment'), 'string')]
