...

{
    ...
    "category": "Sale",
    "depends": ["sale", "purchase", "tender_flow", "msf_supply_doc_export", "spreadsheet_xml", "account_override", "register_accounting", "msf_homere_interface", "stock_override"],
    "init_xml": [],
    "update_xml": [
        ...
        'view/internal_move_import_lines_view.xml',
