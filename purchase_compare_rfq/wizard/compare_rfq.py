        ...
        for wiz in self.browse(cr, uid, ids, context=context):
            ...
            for product_line in wiz.line_ids:
                for po_line in product_line.po_line_ids:
                    ...
                    if product_line.supplier_id and po_line.order_id.partner_id.id != product_line.supplier_id.id:
                        unlink_lines.append(po_line.id)
                    elif product_line.supplier_id and po_line.order_id.partner_id.id == product_line.supplier_id.id:
