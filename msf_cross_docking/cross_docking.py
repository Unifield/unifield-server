...
# ----------------------------------------------------------------------------------------------------------------
    ...
    def _do_partial_hook(self, cr, uid, ids, context, *args, **kwargs):
        ...
        # location_id is equivalent to the source location: does it exist when we go through the "_do_partial_hook" in
        #the msf_cross_docking> stock_partial_piking> "do_partial_hook"
