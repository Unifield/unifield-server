...
That means Not price, Neither Delivery requested date. """))
            try:
                if row.cells[0].data or row.cells[2].data or row.cells[3].data or row.cells[4].data or row.cells[5].data:
...
Product Code*, Product Description*, Quantity*, Product UoM*, Unit Price*, Delivery Requested Date*, Currency*, Comment. """))
            try:    
                ...
                if not row.cells[0].data and not row.cells[2].data and not row.cells[3].data and not row.cells[4].data and not row.cells[5].data and not row.cells[6].data and not row.cells[7].data:
                    continue
                        ...
                        try:
                            ...
                            if currency_ids:
                                if currency_ids[0] == browse_sale.pricelist_id.currency_id.id:
                                    ...
                                    imported_curr_name = currency_obj.browse(cr, uid, currency_ids, context=context)[0].name
                ...
                if fc_id:
                    ...
                    error_list.append(msg or 'The Currency Name was not found.')
                    show_msg_ok = True
