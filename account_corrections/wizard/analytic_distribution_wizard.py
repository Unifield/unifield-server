...
class analytic_distribution_wizard(osv.osv_memory):
    ...
    def do_analytic_distribution_changes(self, cr, uid, wizard_id, distrib_id):
        ...
        for line in to_reverse:
            ...
            reversed_ids = self.pool.get('account.analytic.line').reverse(cr, uid, to_reverse_ids[0])
            ...
            self.pool.get('account.analytic.line').write(cr, uid, [reversed_ids[0]], {'reversal_origin': to_reverse_ids[0], 'last_corrected_id': False})
            ...
            for ret_id in ret:
                self.pool.get('account.analytic.line').write(cr, uid, [ret[ret_id]], {'last_corrected_id': to_reverse_ids[0]})
